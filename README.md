...
<body style="background-image: url(software.jpg);">
    <header>
        ...
        <div class="logo">
            <img src="logo.jpeg" alt="" width="200px" height="200px">
        </div>
        <div class="title">
...
<body>
    ...
    <div class="search" >
        ...
        <div class="cirpic">
            <img class="small border" src="image1.jpg" width="400px">
            <img class="small border" src="image2.jpg" width="400px" >
            <img class="small border" src="image3.jpeg" width="400px">
            <img class="small border" src="image4.jpeg" width="400px" >
            <img class="small border" src="image5.jpg" width="400px">
            <img class="small border" src="image6.jpeg" width="400px" >
        </div>
        <div class ="text">
        ...
        <div class="text2">
            ...
            <footer>
                Designed and Developed by AHALYA S&copy; 2023
                </footer>
...
<body>
  <header>
   ...
   <div class="h1">
    <h1> SERVICES GOING ON BY ZIFO>!</h1>
    </div>
    <div class="im">
<img src="products.jpg" alt="" width="1000px" height="450px">
</div>
  <footer>
    <p>Designed And Developed By: AHALYA S &copy;2023</p>
</footer>
...
.srch:focus{
    ...
    <body>
        ...
        <div class="info">
            ...
            <b>Address: </b>,21A, Anna Salai, Little Mount, Saidapet, Chennai-600119. <br><br>
            <b>Email: </b>zifo@gmail.com<br>
            <b>Phone: </b>
